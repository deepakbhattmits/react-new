...
class  SimpleForm extends Component {
    ...
    return (
      ...
      <div>
        <button className="ui button default primary" type="submit" disabled={ pristine || submitting }>Submit</button>
        <button className="ui button default negative" type="button" disabled={ pristine || submitting} onClick={ reset }>
          Clear Values
        </button>
      </div>
    </form>
