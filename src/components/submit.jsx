							...
							<div className='form-box'>
								<form
									...
									<div className='row '>
										...
										<div className='col-sm-6'>
											<button
												className='btn btn-primary btn btn-primary btn-form display-4'
												disabled={
													this.state.FirstName === '' ||
													this.state.LastName === '' ||
													this.state.HomeTown === '' ||
									...
									<div className='row text-center msg-div'></div>
									<p>{this.state.msg}</p>
								</form>
								<div className='row'>
									<button className='btn btn-primary btn btn-primary btn-form display-4'>
